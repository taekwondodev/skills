...
3. If it requires judgment, make the instruction more prominent and add an example of the failure mode.
...
**Corollary:** If the fix is structural, use the structural fix and remove the redundant instruction.
