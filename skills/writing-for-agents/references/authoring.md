# Authoring design reference

Load this reference when designing or restructuring agent-facing documents or skills, including choices about information hierarchy, pointers, disclosure, splitting, completion criteria, and pruning. Do not load it for routine title or comment work; use the parent [operational contract](../SKILL.md).
...
The parent [`SKILL.md`](../SKILL.md) is the source of truth for shared prose rules. This reference extends it with authoring design guidance. A specialized writer may add artifact-specific format or domain constraints, but it must not contradict the parent contract.
